import { FaExclamationCircle, FaPrint, FaTrash, FaCheck } from 'react-icons/fa'
    ...
    <SimpleModal isOpen={isOpen} onClose={onClose} title={title}>
      <div className="space-y-4">
        <div className="flex items-center justify-center mb-4">
          <div className={`p-3 rounded-full ${confirmColor === 'red' ? 'bg-red-100 text-red-600' : confirmColor === 'blue' ? 'bg-blue-100 text-blue-600' : 'bg-green-100 text-green-600'}`}>
